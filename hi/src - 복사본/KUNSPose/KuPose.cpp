...
@brief English : 
*/
void KuPose::setObsID(int nObsID)
{
	m_nObsID = nObsID;
}
...
@brief English : 
*/
void KuPose::setGroup(int nGroup)
{
	m_nGroup = nGroup;
}
...
/**
 ...
 @brief English : 
 */
void KuPose::setLastResult(Point2f Resultpoint)
{
	m_fResult = Point2f(Resultpoint.x, Resultpoint.y);
}