...
@brief English:
*/
KuGradientPathPlannerbasedPOMapPr::KuGradientPathPlannerbasedPOMapPr()
{
...
@brief English:
*/
void KuGradientPathPlannerbasedPOMapPr::setRadiusofRobot(int nRadiusofRobot)
{
...
@brief English:
*/
void KuGradientPathPlannerbasedPOMapPr::setMap(int** nMap,double dCellSize)
{
		m_smtnMap = nMap;
...
@brief English:
*/
void KuGradientPathPlannerbasedPOMapPr::setProMap(double** dMap)
{	
...
@brief English:
*/
void KuGradientPathPlannerbasedPOMapPr::initializeMapSize(int nMapSizeX, int nMapSizeY)
{
...
@brief English:
*/
void KuGradientPathPlannerbasedPOMapPr::initialize()
{
    m_binitProMapflag=false;
...
@brief English:
*/
void KuGradientPathPlannerbasedPOMapPr::initMap()
{
	int** nMap = m_smtnMap;
...
@brief English:
*/
int KuGradientPathPlannerbasedPOMapPr::generatePath(KuPose GoalPos, KuPose RobotPos)
{
...
@brief English:
*/
void KuGradientPathPlannerbasedPOMapPr::calNavCost()
{
    for (int i=0; i<m_nMapSizeX; i++) {
        for (int j=0; j<m_nMapSizeY; j++) {
...
@brief English:
*/
void KuGradientPathPlannerbasedPOMapPr::calAdjCost(int nGoalPosition[2])
{
...
@brief English:
*/
bool KuGradientPathPlannerbasedPOMapPr::calAdjCostUp(int nI, int nJ, float fValue)
{
        // boundary condition
...
@brief English:
*/
bool KuGradientPathPlannerbasedPOMapPr::calAdjCostDown(int nI, int nJ, float fValue)
{
        // boundary condition
        if (nI<1 || nI>m_nMapSizeX-2 || nJ<1 || nJ>m_nMapSizeY-2) return false;
        if (m_fIntCost[nI+1][nJ] == INFINITY_VALUE){m_fAdjCost[nI+1][nJ] = INFINITY_VALUE; return false;}	
...
@brief English:
*/
bool KuGradientPathPlannerbasedPOMapPr::calAdjCostLeft(int nI, int nJ, float fValue)
{
        // boundary condition
        if (nI<1 || nI>m_nMapSizeX-2 || nJ<1 || nJ>m_nMapSizeY-2) return false;
...
@brief English:
*/
bool KuGradientPathPlannerbasedPOMapPr::calAdjCostRight(int nI, int nJ, float fValue)
{
        // boundary condition
        if (nI<1 || nI>m_nMapSizeX-2 || nJ<1 || nJ>m_nMapSizeY-2) return false;
        if (m_fIntCost[nI][nJ+1] == INFINITY_VALUE) {m_fAdjCost[nI][nJ+1] = INFINITY_VALUE; return false;}	
...
@brief English:
*/
bool KuGradientPathPlannerbasedPOMapPr::calAdjCostUpRight(int nI, int nJ, float fValue)
{
        // boundary condition
        if (nI<1 || nI>m_nMapSizeX-2 || nJ<1 || nJ>m_nMapSizeY-2) return false;
...
@brief English:
*/
bool KuGradientPathPlannerbasedPOMapPr::calAdjCostDownLeft(int nI, int nJ, float fValue)
{
        // boundary condition
        if (nI<1 || nI>m_nMapSizeX-2 || nJ<1 || nJ>m_nMapSizeY-2) return false;
        if (m_fIntCost[nI+1][nJ-1] == INFINITY_VALUE){m_fAdjCost[nI+1][nJ-1] = INFINITY_VALUE; return false;}	
...
@brief English:
*/
bool KuGradientPathPlannerbasedPOMapPr::calAdjCostLeftUp(int nI, int nJ, float fValue)
{
        // boundary condition
        if (nI<1 || nI>m_nMapSizeX-2 || nJ<1 || nJ>m_nMapSizeY-2) return false;
        if (m_fIntCost[nI-1][nJ-1] == INFINITY_VALUE) {m_fAdjCost[nI-1][nJ-1] = INFINITY_VALUE; return false;}
...
@brief English:
*/
bool KuGradientPathPlannerbasedPOMapPr::calAdjCostRightDown(int nI, int nJ, float fValue)
{
        // boundary condition
        if (nI<1 || nI>m_nMapSizeX-2 || nJ<1 || nJ>m_nMapSizeY-2) return false;
        if (m_fIntCost[nI+1][nJ+1] == INFINITY_VALUE){m_fAdjCost[nI+1][nJ+1]  = INFINITY_VALUE; return false;}	
...
@brief English:
*/
list<KuPose> KuGradientPathPlannerbasedPOMapPr::getPath()
{
	return m_listPath;
}
/**
...
@brief English:
*/
void KuGradientPathPlannerbasedPOMapPr::initIntCost(int nRange )
{
...
@brief English:
*/
void KuGradientPathPlannerbasedPOMapPr::calCastIntrinCost(int nRange)
...
@brief English:
*/
void KuGradientPathPlannerbasedPOMapPr::calCastPredictCost(int nRange)
{  
	for (int i=nRange ; i<m_nMapSizeX-nRange ; i++) {
		for (int j=nRange ; j<m_nMapSizeY-nRange ; j++){
			if ( m_dMap[i][j]>1){ //== KuMap::OCCUPIED_AREA ){ 
...
@brief English:
*/
bool KuGradientPathPlannerbasedPOMapPr::extractGradientPath(int nStartPosition[2],int nGoalPosition[2])
{
	KuPose Path;
...
@brief English:
*/
int KuGradientPathPlannerbasedPOMapPr::calGradient(int nX,int nY,int nGradientnum)
{
	double dCost[16]={0};
...
@brief English:
*/
void KuGradientPathPlannerbasedPOMapPr::calAdjCostR(int nGoalPosition[2])
{
...
@brief English:
*/
bool KuGradientPathPlannerbasedPOMapPr::calAdjCostUpR(int nI, int nJ, float fValue)
{
	// boundary condition
	if (nI<1 || nI>m_nMapSizeX-2 || nJ<1 || nJ>m_nMapSizeY-2) return false;
...
@brief English:
*/
bool KuGradientPathPlannerbasedPOMapPr::calAdjCostDownR(int nI, int nJ, float fValue)
{
	// boundary condition
	if (nI<1 || nI>m_nMapSizeX-2 || nJ<1 || nJ>m_nMapSizeY-2) return false;
	if (m_fIntCost[nI+1][nJ] == INFINITY_VALUE){m_fRemovalCost[nI+1][nJ] = INFINITY_VALUE; return false;}	
...
@brief English:
*/
bool KuGradientPathPlannerbasedPOMapPr::calAdjCostLeftR(int nI, int nJ, float fValue)
{
	// boundary condition
	if (nI<1 || nI>m_nMapSizeX-2 || nJ<1 || nJ>m_nMapSizeY-2) return false;
...
@brief English:
*/
bool KuGradientPathPlannerbasedPOMapPr::calAdjCostRightR(int nI, int nJ, float fValue)
{
	// boundary condition
	if (nI<1 || nI>m_nMapSizeX-2 || nJ<1 || nJ>m_nMapSizeY-2) return false;
	if (m_fIntCost[nI][nJ+1] == INFINITY_VALUE) {m_fRemovalCost[nI][nJ+1] = INFINITY_VALUE; return false;}	
...
@brief English:
*/
bool KuGradientPathPlannerbasedPOMapPr::calAdjCostUpRightR(int nI, int nJ, float fValue)
{
	// boundary condition
	if (nI<1 || nI>m_nMapSizeX-2 || nJ<1 || nJ>m_nMapSizeY-2) return false;
...
@brief English:
*/
bool KuGradientPathPlannerbasedPOMapPr::calAdjCostDownLeftR(int nI, int nJ, float fValue)
{
	// boundary condition
	if (nI<1 || nI>m_nMapSizeX-2 || nJ<1 || nJ>m_nMapSizeY-2) return false;
	if (m_fIntCost[nI+1][nJ-1] == INFINITY_VALUE){m_fRemovalCost[nI+1][nJ-1] = INFINITY_VALUE; return false;}	
...
@brief English:
*/
bool KuGradientPathPlannerbasedPOMapPr::calAdjCostLeftUpR(int nI, int nJ, float fValue)
{
	// boundary condition
	if (nI<1 || nI>m_nMapSizeX-2 || nJ<1 || nJ>m_nMapSizeY-2) return false;
	if (m_fIntCost[nI-1][nJ-1] == INFINITY_VALUE) {m_fRemovalCost[nI-1][nJ-1] = INFINITY_VALUE; return false;}
...
@brief English:
*/
bool KuGradientPathPlannerbasedPOMapPr::calAdjCostRightDownR(int nI, int nJ, float fValue)
{
	// boundary condition
	if (nI<1 || nI>m_nMapSizeX-2 || nJ<1 || nJ>m_nMapSizeY-2) return false;
	if (m_fIntCost[nI+1][nJ+1] == INFINITY_VALUE){m_fRemovalCost[nI+1][nJ+1]  = INFINITY_VALUE; return false;}	
...
void KuGradientPathPlannerbasedPOMapPr::setProMapWeight(double dProMapWeight)
{
