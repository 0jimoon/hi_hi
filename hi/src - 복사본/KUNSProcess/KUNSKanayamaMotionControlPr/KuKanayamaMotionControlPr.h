...
#ifndef KUNS_KANAYAMA_MOTION_CONTROL_PROCESS_H
#define KUNS_KANAYAMA_MOTION_CONTROL_PROCESS_H
...
public:
	...
	void setParaValue(double dDesiredVel, double dDesiredRotVel, double fOffsetlength);
...
public:
	...
	KuVelocity generateTRVelocityWithOffset(KuPose TargetPos, KuPose RobotPos);
