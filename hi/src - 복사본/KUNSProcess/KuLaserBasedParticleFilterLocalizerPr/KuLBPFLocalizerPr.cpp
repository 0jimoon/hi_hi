...
// list<MatrixElement> KuLBPFLocalizerPr::getCovariance()
// {
// 	return m_lMatrixElement;
// }
...
{
//	KuSmartPointer<KuCriticalSection> CriticalSection = new KuCriticalSection; 
	//m_CriticalSection.Lock();
		m_CriticalSection.Lock();
...
{
	m_ParticleFilter.setSamplesLocalTracking(RobotPos.getX(), RobotPos.getY(), RobotPos.getThetaRad(), dRegionSize);
...
/**
 ...
 @brief English: 
*/
KuPose KuLBPFLocalizerPr::estimateRobotPos(int_1DArray nRangeData, KuPose EncoderDelPos)
{
