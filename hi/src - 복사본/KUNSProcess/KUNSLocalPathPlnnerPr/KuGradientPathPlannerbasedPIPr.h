...
#ifndef KUNS_GRADIENT_PATHPLANNER_BASED_PREDICTED_INFORMATION_PROCESS_H
#define KUNS_GRADIENT_PATHPLANNER_BASED_PREDICTED_INFORMATION_PROCESS_H
...
using namespace std;
class KuGradientPathPlannerbasedPIPr 
{
...
private:
	KuSmartPointer<int*> m_smtnMap; //지도정보를 저장할 공간.
	KuMath m_math;
...
public:
    ...
    void setRadiusofRobot(int nRadiusofRobot);
	...
	void copyLocalMapToGlobalMap(KuPose RobotPos);



	KuGradientPathPlannerbasedPIPr();
	~KuGradientPathPlannerbasedPIPr();
...
#endif /*KUNS_GRADIENT_PATHPLANNER_BASED_PROMAP_PROCESS_H*/
