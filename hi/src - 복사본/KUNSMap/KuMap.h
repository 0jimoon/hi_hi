...
public:
	...
	static const int OCCUPIED_CHAIR_GRID = 32;
	static const int OCCUPIED_BED_GRID = 33;
	static const int OCCUPIED_SHELF_GRID = 34;

	static const int OCCUPIED_OBSTACLES_GRID = 1000;
