...
{
	int_1DArray pLRFRangeData_181=m_KuUtil.generateIntType1DArray(Sensor::URG04LX_DATA_NUM181,0);
	//m_CriticalSection.Lock();
	int nDeg=0;
	m_CriticalSection.Lock();
	for(int i=nDeg;i<Sensor::URG04LX_DATA_NUM181;i++)
	{
		pLRFRangeData_181[i]= m_LRFRangeData_181[i-nDeg];
	}	
