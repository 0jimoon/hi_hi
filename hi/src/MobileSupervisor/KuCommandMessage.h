...
public:
	...
	static const int GOTOGOAL_BH = 4;	
	static const int HYBRID_MAP_BUILDING_BH = 5;
	static const int PATH_TEACHING_BH= 6;

	static const int VIRTUAL_GOTOGOAL_BH = 11;
	static const int WANDERING_OBSTACLE_PR = 12;
	static const int AUTONOMOUS_GOTOGOAL= 13;
