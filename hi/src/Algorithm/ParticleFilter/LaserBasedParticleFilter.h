#ifndef LASER_BASED_PARTICLE_FILTER_H
#define LASER_BASED_PARTICLE_FILTER_H
//////////////////////////////////////////////////////////////////////
...
private:
	double m_dDeviationforTransConverced; // 병진운동에 대한 불확실성
	double m_dDeviationforRotateConverced; // 회전운동에 대한 불확실성.
	double m_dDeviationforTransRotateConverced; 	// 병진운동이 회전운동에 영향을 주는 불확실성.
...
public:
	...
	void setDeviation(double dDevationforTrans, double dDevationforRotae,double dDevationforTransRotae );
	//----------------------------------------------------------------------------------------------------------------
   ...
   int getSampleNum() { return m_nSampleNum;};
	void resetSamplesNearRobot(double x, double y, double t, double dSize);
	void setSamplesLocalTracking(double x, double y, double t, double dSize);
...
private:
	...
	double m_nRobotPosForLocalTracking[4];
	...
	void RayTracer(int x_1, int x_2, int y_1, int y_2, int *hit_x, int *hit_y);
	//----------------------------------------------------------------------------------------------------------------
