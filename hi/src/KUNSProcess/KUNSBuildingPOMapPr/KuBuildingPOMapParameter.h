#ifndef C_PROBABILITY_MAP_BUILDER_PARAMETER_H
#define C_PROBABILITY_MAP_BUILDER_PARAMETER_H
...
using namespace std;
class KuBuildingPOMapParameter
{
...
public:
	...
	void setPath(string strMapFilePath);
	string getPath();


	KuBuildingPOMapParameter();
	virtual ~KuBuildingPOMapParameter();
