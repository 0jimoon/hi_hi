#ifndef C_SRPM_MAP_BUILDER_PARAMETER_H
#define C_SRPM_MAP_BUILDER_PARAMETER_H
...
using namespace std;
class KuSRPMMapBuilderParameter
{
...
public:
	...
	void setLocalMappingflag(bool bLocalMappingflag);
	bool getLocalMappingflag();

	KuSRPMMapBuilderParameter();
	virtual ~KuSRPMMapBuilderParameter();
